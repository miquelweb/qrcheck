...
b.error("Unknown method")};b.scroller={setDefaults:function(a){b.extend(B,a)},presets:{},themes:{}}})(jQuery);(function(b){var x=new Date,J={dateFormat:"mm/dd/yy",dateOrder:"mmddy",timeWheels:"hhiiA",timeFormat:"hh:ii A",startYear:x.getFullYear()-100,endYear:x.getFullYear()+10,monthNames:"January,February,March,April,May,June,July,August,September,October,November,December".split(","),monthNamesShort:"Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec".split(","),dayNames:"Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday".split(","),dayNamesShort:"Sun,Mon,Tue,Wed,Thu,Fri,Sat".split(","),shortYearCutoff:"+10",
monthText:"Mes",dayText:"DIa",yearText:"Any",hourText:"Hores",minuteText:"Minuts",secText:"Segons",ampmText:"&nbsp;",stepHour:1,stepMinute:1,stepSecond:1,separator:" "},x=function(r){function l(a,b,c){return void 0!==n[b]?+a[n[b]]:void 0!==c?c:A[m[b]]?A[m[b]]():m[b](A)}function p(a,b){return Math.floor(a/b)*b}function o(a){var b=l(a,"h",0);return new Date(l(a,"y"),l(a,"m"),l(a,"d",1),l(a,"ap")?b+12:b,l(a,"i",0),l(a,"s",0))}var k=b(this),s={},d;if(k.is("input")){switch(k.attr("type")){case "date":d=
