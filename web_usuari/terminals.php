...
<div class="caixa"><a href="#" onclick="mostraterminal();return false;"><img id="filtre_terminal" src="img/temp_filtre_terminal.png" width="140" height="180" /></a></div>
<div id="logolacaixa"><img src="img/logo_lacaixa.png" width="140" height="41" /></div>
 </div>
  <div id="central">
<div class="header"><h3>DADES TERMINAL</h3></div>
<div class="caixa"><img id="dades_terminal" src="img/temp_dades_terminal.png" width="537" height="531" style="display:none" /></div>
  </div>
  <div id="dreta">
