...
<div id="contingut"> 
<form name="tiquets_detall" method="post" action="tiquets_detall_bloq.php">
</form>
<div class="taula">
...
$total=mysql_num_rows($detall);
	...
	if($total>0){
     ...
     <div class="cella" style="width:46px;"><?php echo date("h:i",strtotime($dades["dataoperacio"]));?></div>
			...
			<div class="cella" style="width:74px;<?php if($dades["estat"]!=1){echo "color:#fff;background-color:#CD161C";}?>"><?php if($dades["estat"]==1){echo "PAGAT";}else{echo "PENDENT";}?></div>
