...
<div id="contingut">
<div id="baseclick"  onclick="document.forms['tiquets_detall'].submit()" >
</div>
<form name="tiquets_detall" method="post" action="tiquets_detall.php">
</form>
<form name="principal" method="post" action="principal.php">
</form>
<div id="botocancela"><a href="#" onclick="document.forms['principal'].submit();return false;"><img src="img/boto_cancela.png" width="288" height="47" /></a></div>
