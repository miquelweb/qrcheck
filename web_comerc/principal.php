...
$query = "SELECT * FROM comercos WHERE usuaricomerc='".$_POST["nom"]."' and passwordcomerc='".$_POST["password"]."'";	
...
<title>QRcheck - Edició comerç</title>
...
<div id="superior2">
  ...
  <div id="menusuperior">
<a href="home.php" onClick="$('#contingut').load('home.php');return false"><img id="menu_home" src="img/menu_home_o.png" width="48" height="48" /></a><a href="operacions.php" onClick="$('#contingut').load('operacions.php');return false"><img id="menu_operacions" src="img/menu_operacions.png" width="48" height="48" alt="GESTIO" /></a><a href="operacions.php" onClick="$('#contingut').load('productes.php');return false"><img id="menu_productes" src="img/menu_productes.png" width="48" height="48" alt="GESTIO" /></a><a href="usuaris.php" onClick="$('#contingut').load('usuaris.php');return false"><img id="menu_usuaris" src="img/menu_usuaris.png" width="48" height="48" /></a>
<div id="mifas"></div>
  </div>
    <div id="logout">
