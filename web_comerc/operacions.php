...
$query = "SELECT * FROM operacions LEFT JOIN comercos ON operacions.codicomerc=comercos.codicomerc WHERE operacions.codicomerc='".$_SESSION["comerc"]."'";	
...
<div id="logolacaixa"><img src="img/logo_lacaixa.png" width="140" height="41" /></div>
  ...
  <div id="central">
<div class="header"><h3>HIST&Ograve;RIC DE COBRAMENTS</h3></div>
...
<div class="headertaula"> 
            ...
            <div class="cella" style="width:130px;">SUCURSAL</div>
